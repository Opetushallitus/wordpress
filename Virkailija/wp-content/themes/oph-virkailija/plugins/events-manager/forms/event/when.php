...
<div class="event-form-when" id="em-form-when">
	...
	<p class="em-time-range">
		...
		<input id="start-time" class="em-time-input em-time-start" type="text" size="8" maxlength="8" name="event_start_time" value="<?php echo date( $hours_format, ( !empty($EM_Event->start) ? $EM_Event->start:'28800' ) ); ?>" />
		<?php _e('to','dbem'); ?>
		<input id="end-time" class="em-time-input em-time-end" type="text" size="8" maxlength="8" name="event_end_time" value="<?php echo date( $hours_format, ( !empty($EM_Event->end) ? $EM_Event->end:'28800' ) ); ?>" />
