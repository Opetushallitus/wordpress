...
$password = 'secret';
$host = 'luokka.hard.ware.fi';
$domain = 'test-virkailija.oph.ware.fi';
$basedn = 'dc=example,dc=com';
$group = 'SomeGroup';

$ad = ldap_connect("luokka.hard.ware.fi:10389") or die('Could not connect to LDAP server.');
ldap_set_option($ad, LDAP_OPT_PROTOCOL_VERSION, 3);
ldap_set_option($ad, LDAP_OPT_REFERRALS, 0);
@ldap_bind($ad, 'uid=admin,ou=system', 'secret') or die('Could not bind to AD.');
